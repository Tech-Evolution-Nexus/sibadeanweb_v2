<aside class=" md:min-w-[300px] md:sticky md:left-0 min-w-full h-screen overflow-auto  fixed top-0   z-10  transition-all  flex flex-col bg-white" :class="{'left-[-100%]': ! sidebarOpen, 'left-0': sidebarOpen }">
    ...
    <div class="flex px-4 py-4 gap-2  flex-col flex-grow justify-between">
        <ul class=" ">
            <li class="fi-sidebar-item-label flex-1 truncate text-sm font-medium text-primary-600 dark:text-primary-400">
                <!-- <span class="text-lg text-gray-600 block mb-2">Dashboard</span> -->
                <a href="{{route("dashboard")}}" class="block   px-2 py-1 {{request()->is('c/*/dashboard') ? 'bg-[var(--primary)] text-white' : 'text-slate-700 md:hover:bg-gray-100'}} transition-all   rounded-md text-sm flex items-center gap-2"><i class="fa w-[30px] fa-border-all text-lg"></i> Dashboard</a>
            </li>
            {{-- <hr class="block mt-6 mb-2 border-slate-300"> --}}
            <li class="fi-sidebar-item-label flex-1 truncate text-sm font-medium text-primary-600 dark:text-primary-400">
                <!-- <span class="text-lg text-gray-600 block mb-2">Dashboard</span> -->
                <a href="{{route("pengajuan-surat.index")}}" class="block   px-2 py-1 {{request()->is("c/*/pengajuan-surat") ? 'bg-[var(--primary)] text-white' : 'text-slate-700 md:hover:bg-gray-100'}} transition-all   rounded-md text-sm flex items-center gap-2"><i class="fa w-[30px] fa-envelope text-lg"></i> Surat Masuk</a>
            </li>
            <li class="fi-sidebar-item-label flex-1 truncate text-sm font-medium text-primary-600 dark:text-primary-400">
                <!-- <span class="text-lg text-gray-600 block mb-2">Dashboard</span> -->
                <a href="{{route("pengajuan-surat.index")}}" class="block   px-2 py-1 {{request()->is(route("pengajuan-surat.index")) ? 'bg-[var(--primary)] text-white' : 'text-slate-700 md:hover:bg-gray-100'}} transition-all   rounded-md text-sm flex items-center gap-2"><i class="fa w-[30px] fa-envelope text-lg"></i> Surat Keluar</a>
            </li>
                ...
                <ul class="overflow-hidden transition-all duration-300 ease-in-out mt-4"
                    ...
                    <li>
                        <a href="{{ route('rw.index') }}"
                            class="flex  px-2 py-2 rounded-md text-sm  items-center gap-2 text-gray-700 hover:bg-gray-100 transition-all font-medium">
                            <i class="fa fa-circle text-gray-400 text-[6px] w-6"></i> RT & RW
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('kartu-keluarga.index') }}"
                            class="flex  px-2 py-2 rounded-md text-sm  items-center gap-2 text-gray-700 hover:bg-gray-100 transition-all font-medium">
                            <i class="fa fa-circle text-gray-400 text-[6px] w-6"></i> Kartu Keluarga
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('users.index') }}"
                            class="flex  px-2 py-2 rounded-md text-sm  items-center gap-2 text-gray-700 hover:bg-gray-100 transition-all font-medium">
                            <i class="fa fa-circle text-gray-400 text-[6px] w-6"></i> Users
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('surat.index') }}"
                            class="flex  px-2 py-2 rounded-md text-sm  items-center gap-2 text-gray-700 hover:bg-gray-100 transition-all font-medium">
                            <i class="fa fa-circle text-gray-400 text-[6px] w-6"></i> Surat
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('berita.index') }}"
                            class="flex  px-2 py-2 rounded-md text-sm  items-center gap-2 text-gray-700 hover:bg-gray-100 transition-all font-medium">
                            <i class="fa fa-circle text-gray-400 text-[6px] w-6"></i> Berita
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('format-surat.index') }}"
                            class="flex  px-2 py-2 rounded-md text-sm  items-center gap-2 text-gray-700 hover:bg-gray-100 transition-all font-medium">
                            <i class="fa fa-circle text-gray-400 text-[6px] w-6"></i> Format Surat
                        </a>
                    </li>
                </ul>
            </li>
                ...
                <ul class="overflow-hidden transition-all duration-300 ease-in-out mt-4"
                    ...
                    <li>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            @csrf
                            <button type="submit" class=" flex  px-2 py-2 rounded-md text-sm  items-center gap-2 text-gray-700 hover:bg-gray-100 transition-all font-medium w-full"><i class="fa fa-circle text-gray-400 text-[6px] w-6"></i> Logout</button>
