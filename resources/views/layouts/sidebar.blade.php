<aside
    class=" md:min-w-[300px] md:sticky md:left-0 min-w-full h-screen overflow-auto   fixed top-0 border-r  z-10  transition-all  flex flex-col bg-white hide-scroll"
    :class="{'left-[-100%]': ! sidebarOpen, 'left-0': sidebarOpen }">
    <div class="logo p-4 flex justify-between">
        <a href="{{ route('dashboard') }}">
            <img src="{{asset(auth()->user()->pengaturan()->logo_horizontal ? "assets/logos/" . auth()->user()->pengaturan()->logo_horizontal : "image/default-2.png")}}"
                alt="" class="h-[40px]">
        </a>
    ...
    {{-- <div class=" px-4 ">
        <div class="flex gap-2 items-center bg-gray-200 w-full p-2 rounded-md">
            <img src="{{asset(" assets/image/".auth()->user()->avatar)}}" alt="profile image" class="w-[50px] h-[50px]
    ...
    <div class="flex px-4 py-4 gap-2  flex-col flex-grow justify-between">
        <ul class="">
            <li
                class="fi-sidebar-item-label flex-1 my-2 truncate text-sm font-medium text-primary-600 dark:text-primary-400">
                <!-- <span class="text-lg text-gray-600 block mb-2">Dashboard</span> -->
                <a href="{{route("dashboard")}}"
                    class="block   px-2 py-1 {{request()->is('c/*/dashboard') ? 'text-[var(--primary)] bg-gray-100' : 'text-slate-700 md:hover:bg-gray-100'}} transition-all   rounded-md text-sm flex items-center gap-2"><i
                        class="fa w-[30px] fa-border-all text-lg"></i> Dashboard</a>
            </li>
            {{--
            ...
            <li class="fi-sidebar-item-label flex-1 my-2 truncate text-sm font-medium text-primary-600 dark:text-primary-400"
                x-data="{ isCollapse: true }">
                <div @click="isCollapse = !isCollapse"
                    class="flex justify-between items-center text-gray-800 transition-all">
                    <div class="   px-2 py-1  transition-all   rounded-md text-sm flex items-center gap-2"><i
                            class="fa w-[30px] fa-envelope text-lg"></i> Surat Masuk</div>
                    <i class="fa transition-transform duration-300"
                        :class="{'fa-chevron-down': isCollapse, 'fa-chevron-up': !isCollapse}"></i>
                </div>
                ...
                <ul class="overflow-hidden transition-all duration-300 ease-in-out px-4"
                    ...
                    <li>
                        <a href="{{ route('pengajuan-surat.index') }}"
                            class="flex  px-2 py-2 rounded-md text-sm  items-center gap-2  hover:bg-gray-100 transition-all font-medium {{request()->routeIs("pengajuan-surat.index") && (request()->query('status') == 'menunggu' || request()->query('status') == '') ? 'text-[var(--primary)] bg-gray-100' : 'text-slate-700 md:hover:bg-gray-100'}}">
                            <div class="">
                                <i
                                    class="fa fa-circle {{request()->routeIs("pengajuan-surat.index") && (request()->query('status') == 'menunggu' || request()->query('status') == '') ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                                Menunggu Persetujuan
                            </div>
                            <span
                                class=" items-center rounded-md bg-gray[--primary] px-2 py-1 text-xs font-medium text-[--primary] ring-1 ring-[--primary] ring-inset ms-auto {{Helpers::getCountPengajuan()->countMenungguPengajuan ? "inline-flex" : "hidden"}}">{{Helpers::getCountPengajuan()->countMenungguPengajuan}}</span>
                    ...
                    <li>
                        <a href="{{ route('pengajuan-surat.index') }}?status=di_terima_rt"
                            ...
                            <i
                                class="fa fa-circle {{request()->routeIs("pengajuan-surat.index") && request()->query('status') == 'di_terima_rt' ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                            Disetujui Rt
                        </a>
                    </li>
                    <li>
                        <a href="{{ route('pengajuan-surat.index') }}?status=selesai"
                            ...
                            <i
                                class="fa fa-circle {{request()->routeIs("pengajuan-surat.index") && request()->query('status') == 'selesai' ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                            Selesai
                        </a>
                    </li>
                </ul>
            ...
            <li
                ...
                <a href="{{route("surat-keluar.index")}}"
                    class="block   px-2 py-1 {{request()->is('c/*/surat-keluar') ? 'text-[var(--primary)] bg-gray-100' : 'text-slate-700 md:hover:bg-gray-100'}} transition-all   rounded-md text-sm flex items-center gap-2"><i
                        class="fa w-[30px] fa-envelope text-lg"></i> Surat Keluar</a>
            </li>
                ...
                <ul class="overflow-hidden transition-all duration-300 ease-in-out "
                    ...
                    <li>
                        <a href="{{ route('rw.index') }}"
                            ...
                            <i
                                class="fa fa-circle {{request()->routeIs("rw.index") ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                            RT & RW
                        </a>
                    </li>
                    @if(auth()->user()->role === "admin")
                        <li>
                            <a href="{{ route('kartu-keluarga.index') }}"
                                ...
                                <i
                                    class="fa fa-circle {{request()->routeIs("kartu-keluarga.index") ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                                Kartu Keluarga
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('users.index') }}"
                                ...
                                <i
                                    class="fa fa-circle {{request()->routeIs("users.index") ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                                Users
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('surat.index') }}"
                                ...
                                <i
                                    class="fa fa-circle {{request()->routeIs("surat.index") ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                                Surat
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('berita.index') }}"
                                ...
                                <i
                                    class="fa fa-circle {{request()->routeIs("berita.index") ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                                Berita
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('lampiran.index') }}"
                                ...
                                <i
                                    class="fa fa-circle {{request()->routeIs("lampiran.index") ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                                Lampiran
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('format-surat.index') }}"
                                ...
                                <i
                                    class="fa fa-circle {{request()->routeIs("format-surat.index") ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                                Format Surat
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('faq.index') }}"
                                ...
                                <i
                                    class="fa fa-circle {{request()->routeIs("faq.index") ? 'text-[var(--primary)] bg-gray-100' : 'text-gray-400'}} text-[6px] w-6"></i>
                                FAQ
                            </a>
                        </li>
                    @endif
                    ...
                    <ul class="overflow-hidden transition-all duration-300 ease-in-out mt-4"
                        ...
                        <li>
                            <a href="{{ route('setting.index') }}"
                                ...
                                <i class="fa fa-circle text-gray-400 text-[6px] w-6"></i> Pengaturan
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            ...
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit"
                                    class=" flex text-start  px-2 py-2 rounded-md text-sm  items-center gap-2  hover:bg-gray-100 transition-all font-medium w-full "><i
                                        class="fa fa-circle text-gray-400 text-[6px] w-6"></i> Logout</button>
