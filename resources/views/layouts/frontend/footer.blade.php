<footer class="border-t">
    <div class="container py-10">
        <div class="grid md:grid-cols-2 grid-cols-1 items-end">
            <div class="">
                ...
                <p class="text-sm mt-2">Lorem ipsum dolor sit amet consectetur adipisicing elit. Enim a perspiciatis earum exercitationem et est qui quidem voluptatibus iusto excepturi! </p>
            </div>
