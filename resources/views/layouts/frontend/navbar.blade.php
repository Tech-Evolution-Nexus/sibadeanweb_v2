<header class="py-10 fixed w-full top-0 z-50 transition-all duration-300"
    ...
    <div class="container mx-auto flex justify-between items-center px-4">
        ...
        <a href="/" class="text-lg">
            <img class="rounded-md w-24" src="{{ asset('assets/'.($pengaturan->logo_horizontal?"/logos/$pengaturan->logo_horizontal":"image/default-2.png")) }}" alt="Logo">
        </a>
    ...
    <nav x-show="open" x-transition class="absolute top-full left-0 w-full h-screen bg-white shadow-md md:hidden">
        <ul class="flex flex-col gap-4 p-4">
            <li><a class="block text-sm text-gray-600 hover:text-gray-900" href="/beranda">Beranda</a></li>
