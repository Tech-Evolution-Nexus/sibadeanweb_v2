...
<section class=" py-16 relative">
    <img src="{{ asset("assets/image/bg-hero.png") }}" class="w-full bg-gray-50 h-full opacity-25 absolute inset-0 object-cover z-[-1]" alt="">
    <div class="container min-h-screen flex justify-start md:mt-28 mt-24 flex-col">
        <div class="text-center">
            ...
            <div class="mt-6">
                <a href="#unduh" class="px-6 py-3 bg-[--primary] rounded-md text-white inline-block shadow-md hover:bg-opacity-80 transition-all cursor-pointer">
            ...
            <img src="{{ asset($landing->hero_img) }}" class="md:max-w-3xl rounded-md mx-auto mt-10 drop-shadow-xl " alt="">
        </div>
    </div>
</section>
...
<section id="demo" class="py-16 bg-gray-50">
    <div class="container text-center">
        ...
        <div class="mt-6">
            <iframe class="w-full max-w-3xl mx-auto h-64 md:h-96 shadow-md rounded-md" src="{{ $landing->demo_url}}" frameborder="0" allowfullscreen></iframe>
        </div>
    </div>
</section>
...
<section id="unduh" class="py-16 bg-gray-50">
    <div class="container text-center">
        ...
        <p class="text-gray-600 mt-4 text-sm max-w-3xl mx-auto">
            Nikmati kemudahan akses dalam genggaman Anda! Unduh aplikasi {{ config("app.name") }} untuk pengalaman yang lebih cepat dan nyaman.
        </p>
