<x-app-layout :title="'Pengaturan'">
    <div class="md:px-12 px-6 md:py-4 py-2">
        ...
        <div class="max-w-full">
            ...
            <!-- Form -->
            <form action="{{ route('setting.update', $pengaturan->id) }}" class="card mt-6" method="POST"
                ...
                <div class="grid md:grid-cols-2 grid-cols-1 gap-6">
                    <div>
                        <div class="grid md:grid-cols-2 grid-cols-1 gap-10">
                            <div class="flex flex-col mb-4">
                                ...
                                <label class="w-full md:w-[100px] aspect-video preview-image cursor-pointer mt-1">
                                    ...
                                    <img class="rounded-md"
                                        src="{{ asset('assets/' . ($pengaturan->logo ? "/logos/$pengaturan->logo" : "image/default-2.png")) }}"
                                        alt="">
                                </label>
                            ...
                            <div class="flex flex-col mb-4 ">
                                ...
                                <label class="w-full md:w-[100px] aspect-video preview-image cursor-pointer mt-1">
                                    ...
                                    <img class="rounded-md"
                                        src="{{ asset('assets/' . ($pengaturan->logo ? "/logos/$pengaturan->logo_horizontal" : "image/default-2.png")) }}"
                                        alt="">
                                </label>
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <label for="aktif-rw" class="flex items-center space-x-2 mt-1">
                                <input value="1" {{ $pengaturan->hasRw ? 'checked' : '' }} type="checkbox" id="aktif-rw"
                                    name="hasRw"
                        ...
                        <div class="flex flex-col mb-4">
                            ...
                            <div class="flex items-center space-x-2 border rounded-md border-gray-300 ps-2 py-1 mt-1">
                                <input value="{{ old('primary_color', $pengaturan->primary_color) }}" type="color"
                                    id="primary_color" name="primary_color"
                                    class="w-10 h-10 p-0 m-0 border-none appearance-none  border-r border-gray-100 rounded-full">
                                <input value="{{ old('primary_color', $pengaturan->primary_color) }}" type="text"
                                    id="primary_color_text" placeholder="#FFFFFF"
                                    class="w-[10ch] py-1 px-2 border-0 focus:outline-none">
                            </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex items-center space-x-2 border rounded-md border-gray-300 ps-2 py-1 mt-1">
                                <input value="{{ old('secondary_color', $pengaturan->secondary_color) }}" type="color"
                                    id="secondary_color" name="secondary_color"
                                    class="w-10 h-10 p-0 m-0 border-none appearance-none  border-r border-gray-100 rounded-full">
                                <input value="{{ old('secondary_color', $pengaturan->secondary_color) }}" type="text"
                                    id="secondary_color_text" placeholder="#FFFFFF"
                                    class="w-[10ch] py-1 px-2 border-none rounded-r-md focus:outline-none">
                            </div>
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="flex flex-col">
                            ...
                            <x-text-input :value="old('kelurahan', $pengaturan->kelurahan)" type="text"
                                class="mt-1 block w-full" placeholder="Bataan" name="kelurahan" id="kelurahan"
                                required />
                            <x-input-error :message="$errors->first('kelurahan')" />
                        </div>
                        <div class="flex flex-col">
                            <x-input-label for="kode_pos" :value="__('Kode Pos')" />
                            <x-text-input :value="old('kode_pos', $pengaturan->kode_pos)" type="text"
                                class="mt-1 block w-full" placeholder="68281" maxlength="5" minlength="5"
                                name="kode_pos" id="kode_pos" required />
                            <x-input-error :message="$errors->first('kode_pos')" />
                        </div>
                        <div class="flex flex-col">
                            <x-input-label for="kabupaten" :value="'Kabupaten'" />
                            <x-text-input :value="old('kabupaten', $pengaturan->kabupaten)" type="text"
                                class="mt-1 block w-full" placeholder="Bondowoso" name="kabupaten" id="kabupaten"
                                required />
                            <x-input-error :message="$errors->first('kabupaten')" />
                        </div>
                        <div class="flex flex-col">
                            <x-input-label for="kecamatan" :value="'Kecamatan'" />
                            <x-text-input :value="old('kecamatan', $pengaturan->kecamatan)" type="text"
                                class="mt-1 block w-full" placeholder="Tenggarang" name="kecamatan" id="kecamatan"
                                required />
                            <x-input-error :message="$errors->first('kecamatan')" />
                        </div>
                        <div class="flex flex-col">
                            <x-input-label for="provinsi" :value="'Provinsi'" />
                            <x-text-input :value="old('provinsi', $pengaturan->provinsi)" type="text"
                                class="mt-1 block w-full" placeholder="Jawa Timur" name="provinsi" id="provinsi"
                                required />
