        ...
        <form action="{{ $action_form }}" method="POST">
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 gap-4">
                ...
                <div>
                    ...
                    <x-text-input :value="old('name', $data->name)" type="text" class="block mt-1 w-full" placeholder="Nama Lengkap" name="name" id="name" required />
                ...
                <div>
                    ...
                    <x-text-input :value="old('email', $data->email)" type="email" class="block mt-1 w-full" placeholder="Email" name="email" id="email" required />
                ...
                <div>
                    ...
                    <x-text-input type="password" class="block mt-1 w-full" placeholder="Password" name="password" id="password" />
                ...
                <div>
                    ...
                    <x-text-input :value="old('masa_jabatan_mulai', $data->masa_jabatan_mulai)" type="date" class="block mt-1 w-full" name="masa_jabatan_mulai" id="masa_jabatan_mulai" required />
                ...
                <div>
                    ...
                    <x-text-input :value="old('masa_jabatan_selesai', $data->masa_jabatan_selesai)" type="date" class="block mt-1 w-full" name="masa_jabatan_selesai" id="masa_jabatan_selesai" required />
            ...
            <div class="flex md:justify-end md:flex-row flex-col-reverse mt-8 gap-4">
                <a href="{{ route('user.index') }}" class="px-4 md:w-auto w-full py-2 bg-slate-200 text-center rounded-md text-gray-900">Kembali</a>
