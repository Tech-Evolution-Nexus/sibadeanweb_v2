    ...
    <div class="md:px-12 px-6 md:py-4 py-2">
        <div class="mb-10">
            <div class="text-sm">Dashboard / <a class="hover:underline" href="{{route("kartu-keluarga.index")}}">Kartu
                    keluarga</a> / <span class="text-gray-700 font-semibold">Anggota Keluarga</span></div>
            <div class="flex">
                <h1 class="text-2xl font-bold">Anggota Keluarga</h1>
                <a href="{{route("anggota-keluarga.create", $data->no_kk)}}"
                    class="px-4 py-2 bg-[--primary] rounded-md text-white ms-auto">Tambah </a>
            </div>
        </div>
