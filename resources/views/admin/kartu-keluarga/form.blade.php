        ...
        <form action="<?= $data->action_form ?>" method="POST" class="" enctype="multipart/form-data">
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 gap-2 gap-x-4">
                ...
                <div class=" ms-md-3">
                    ...
                    <x-text-input :value="old('no_kk', $data->data->no_kk)" maxlength="16" minlength="16" type="text"
                        class="only-number block mt-1 w-full" placeholder="Nomor Kartu Keluarga" name="no_kk" id="no_kk"
                        required />
                ...
                <div class=" mb-2">
                    ...
                    <x-text-input :value="old('alamat', $data->data->alamat)" type="text" class="block mt-1 w-full"
                        placeholder="Alamat Lengkap" name="alamat" id="alamat" required />
                ...
                <div class="">
                    <div class=" mb-2 ms-md-3">
                        ...
                        <x-text-input :value="old('nik', $data->data->nik)" maxlength="16" minlength="16" type="text"
                            class="only-number block mt-1 w-full" placeholder="NIK Kepala Keluarga" name="nik" id="nik"
                            required />
                ...
                <div class=" mb-2 ms-md-3">
                    ...
                    <x-text-input :value="old('nama', $data->data->nama)" type="text" class="block mt-1 w-full"
                ...
                <div class=" mb-2 ms-md-3">
                    ...
                    <x-text-input :value="old('kelurahan', $data->data->kelurahan)" readonly type="text"
                        class="bg-gray-100 form-control block w-full mt-1 p-2 border border-gray-300 rounded-md"
                        placeholder="Kelurahan" name="kelurahan" id="kelurahan" required />
                </div>

                <div>
                    <div class=" mb-2">
                        <x-input-label for="kode_pos" :value="__('Kode Pos')" />
                        <x-text-input :value="old('kode_pos', $data->data->kode_pos)" maxlength="5" minlength="5"
                            readonly type="text"
                            class="bg-gray-100 form-control block w-full mt-1 p-2 border border-gray-300 rounded-md"
                            placeholder="kode_pos" name="kode_pos" id="kode_pos" required />
                    </div>
                </div>
                ...
                <div>
                    <div class=" mb-2 ms-md-3">
                        ...
                        <x-text-input :value="old('kabupaten', $data->data->kabupaten)" readonly type="text"
                            class="bg-gray-100 form-control block w-full mt-1 p-2 border border-gray-300 rounded-md"
                            placeholder="kabupaten" name="kabupaten" id="kabupaten" required />
                    </div>
                </div>
                ...
                <div>
                    <div class=" mb-2">
                        ...
                        <x-text-input :value=" old('kecamatan', $data->data->kecamatan)" readonly type="text"
                            class="bg-gray-100 form-control block w-full mt-1 p-2 border border-gray-300 rounded-md"
                            placeholder="kecamatan" name="kecamatan" id="kecamatan" required />
                    </div>
                </div>
                ...
                <div>
                    <div class=" mb-2 ms-md-3">
                        ...
                        <x-text-input :value="old('provinsi', $data->data->provinsi)" readonly type="text"
                            class="bg-gray-100 form-control block w-full mt-1 p-2 border border-gray-300 rounded-md"
                            placeholder="Provinsi" name="provinsi" id="provinsi" required />
                    </div>
                </div>
            </div>
