<x-app-layout :title="$data->title">
    ...
    <div class="md:px-12 px-6 md:py-10 py-5">
        <div class="mb-10">
            <div class="text-sm">Dashboard / <a class="hover:underline" href="{{route("kartu-keluarga.index")}}">RW</a>
                / {{$data->title}}</div>
            <div class="flex">
        ...
        <form action="<?= $data->action_form ?>" method="POST" class="card" enctype="multipart/form-data">
            ...
            <div class="grid md:grid-cols-2 grid-cols-1 gap-x-4 gap-y-2">
                <div class=" md:col-span-2">
                    ...
                    <x-select :disabled="$data->method == 'PUT'" data-placeholder="Cari berdasarkan nama atau NIK"
                        data-allow-clear="true" :options="$options" class=" select2 block mt-1 w-full" name="nik" />
                ...
                <div class=" ">
                    ...
                    <x-text-input type="text" disabled class="block mt-1 w-full bg-slate-100" placeholder="-" name="rw"
                        id="rw" />
                    <x-input-error :messages="$errors->get('rw')" class="mt-2 text-red-500 text-xs" />
                </div>
                <div class=" ">
                    <x-input-label for="rt" :value="__('RT')" />
                    <x-text-input type="text" disabled class="block mt-1 w-full bg-slate-100" placeholder="-" name="rt"
                        id="rt" />
                ...
                <div class=" ">
                    ...
                    <x-text-input type="date" :value="old('masa_jabatan_mulai', $data->data->masa_jabatan_mulai)"
                        class="block mt-1 w-full " placeholder="-" name="masa_jabatan_mulai" id="masa_jabatan_mulai"
                        required />
                ...
                <div class=" ">
                    ...
                    <x-text-input type="date" :value="old('masa_jabatan_selesai', $data->data->masa_jabatan_selesai)"
                        class="block mt-1 w-full " placeholder="masa_jabatan_selesai" name="masa_jabatan_selesai"
                        id="masa_jabatan_selesai" required />
