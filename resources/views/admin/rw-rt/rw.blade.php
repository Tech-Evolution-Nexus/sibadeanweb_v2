<x-app-layout :title="'RW'">
    ...
    <div class="md:px-12 px-6 md:py-4 py-2">
        <div class="mb-10">
            ...
            <div class="flex">
                ...
                <a href="{{route("rw.create")}}" class="px-4 py-2 bg-[--primary] rounded-md text-white ms-auto">Tambah
                    RW</a>
            </div>
        </div>
    ...
    <x-modal :name="'updateStatus'">
        <form :action="url" method="post" class="p-4">
            ...
            <p class="text-slate-500 text-sm">Perubahan akan mengubah status ketua rw menjadi masyarakat</p>
            <div class="flex md:justify-end flex-wrap-reverse gap-2 mt-10">
                <button x-data x-on:click="$dispatch('close-modal',{name:'updateStatus'})" type="button"
