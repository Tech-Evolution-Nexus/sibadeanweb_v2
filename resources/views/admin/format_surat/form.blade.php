                                ...
                                feeds: [
                                    {
                                        ...
                                        feed: [
                                            ...
                                            "{kewarganegaraan}", "{pendidikan}", "{alamat}", "{rw}", "{rt}",
                                            "{pengaju_nama}", "{pengaju_nik}", "{pengaju_tempat_lahir}", "{pengaju_tanggal_lahir}",
                                            "{pengaju_jenis_kelamin}", "{pengaju_pekerjaan}", "{pengaju_agama}", "{pengaju_status_perkawinan}",
                                            "{pengaju_kewarganegaraan}", "{pengaju_pendidikan}", "{pengaju_alamat}", "{pengaju_rw}", "{pengaju_rt}",
                                            "{nama_bapak}",
